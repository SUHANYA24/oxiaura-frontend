 ...
 *
 * A <main> rather than a <div>: this is the whole page, and outside the shell
 * there is no other landmark for a screen reader to land on.
 */
export default function NotFound() {
  return (
    <main className="flex min-h-screen animate-page-enter flex-col items-center justify-center bg-ink-50 px-6 text-center">
